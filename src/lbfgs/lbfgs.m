...
%fprintf('\t Solving optimization with bfgs ...');
...
% output log
if verboseI
    fprintf('%10s %10s %15s %15s %15s %10s\n','Iteration','FunEvals','Step Length','Function Val','Opt Cond','Time');
end
...
for i=1:maxIter
   ...
   % Output iteration information
	timeIt = toc;
   if verboseI
      fprintf('%10d %10d %15.5e %15.5e %15.5e %10.2f\n',i,funEvals*funEvalMultiplier,t,f,optCond,timeIt);
   end
